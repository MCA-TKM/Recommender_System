...
$sq="insert into tbl_cart_master (uid,date,time) values($id,'$date','$time')";
...
$sql="Select max(cid) as mx from tbl_cart_master";
$data=mysqli_query($conn,$sql);
...
$s="insert into tbl_cart_transaction (cid,bid,no_of_copies) values($mx,$bookid,1)";
//mysqli_query($con,$sql);
//echo $s;

mysqli_query($conn,$s);

//$cartsample="insert into tbl_cart (uid,date,time,bid,no_of_copies) values ($id,'$date','$time',$bookid,1)";
//echo $cartsample;

//mysqli_query($conn,$cartsample);
...
$sql="Select * from tbl_cart_master  c, tbl_cart_transaction t , tbl_book b where  c.cid = t.cid and t.bid=b.bid and c.uid=$id ";
$data=mysqli_query($conn,$sql);
