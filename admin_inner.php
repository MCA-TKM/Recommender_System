            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="admin_inner.php"><h3 style="color:orange;">Pick A Book</h3> 
...
<div class="copyrights">
	 <p>© 2018 Pick A Book. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">AlphAkhiAni</a> </p>
</div>	
...
<!--slider menu-->
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        <li id="menu-home" ><a href="admin_inner.php"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li>
		        <li><a href="#"><i class="fa fa-cogs"></i><span>Operations</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul>
		            <li><a href="admin_home.php">Add Books</a></li>
		            <li><a href="admin_approveuser.php">Approve User</a></li>
					<li><a href="admin_addprefer.php">Add Category</a></li>
